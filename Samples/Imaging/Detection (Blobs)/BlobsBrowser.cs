...
namespace SampleApp
{
    ...
    public partial class BlobsBrowser : Control
    {
        ...
        public byte backgroundThresholdR = 0;

        public byte backgroundThresholdG = 255;

        public byte backgroundThresholdB = 0;
        ...
        //
        // Remarks:
        //     The property sets threshold value for distinguishing between background pixel
        //     and objects' pixels. All pixel with values less or equal to this property are
        //     treated as background, but pixels with higher values are treated as objects'
        //     pixels.
        //     In the case of color images a pixel is treated as objects' pixel if any of its
